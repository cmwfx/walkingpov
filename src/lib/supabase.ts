...
export type Video = { id: string; title: string; thumbnail_url: string; tags: string[]; created_at: string; updated_at: string };
...
export type SupportTicket = { id: string; user_id?: string; email?: string; subject: string; status: 'open' | 'closed'; created_at: string; updated_at: string };
